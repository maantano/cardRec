...
// import SelectboxCard2 from "./SelectboxCard2";
...
const Btn = styled.button`
  ...
  text-indent: -9999px;
  color: black;
  /* background: url("https://www.card-gorilla.com/statics/img/icon_reset.png"); */
...
const Search1 = () => {
  ...
  const searchAync = async () => {
    try {
      ...
      console.log("searchData.payload after || searchData =====>", searchData);
    } catch (error) {
  ...
  // useEffect(() => {
  //   console.log("[amount, prevRec, selectCard]  ======> 1", searchList);
  //   searchAync();
  //   console.log("[amount, prevRec, selectCard]  ======> 2", searchList);
