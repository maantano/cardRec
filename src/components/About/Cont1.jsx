...
const Cont1 = () => {
  ...
  }, [filterList, bankList, countTarget, curTab]);

  const navigateToSearchWithList =
    cardType || eventType
      ? () => {
          // Determine the list based on curTab
                  ...
                  <div className="search_results">
                    ...
                    <div className="res">
                      ...
                      <div className="count">
                        <p>
                          <i className="num">
                            {/* {totalCount > 0 ? totalCount : res.length} */}
                      ...
                      <div className="card_view">
                        {/* <div className="card_view" onClick={searchOnClick2}> */}
                        {/* {cardType || eventType ? ( */}
...
//   // console.log(state.rootReducer2.CategoryList);
//   return {
...
export default Cont1;
// export default connect(mapStateToProps, mapDispatchToProps)(Cont1_redux);
