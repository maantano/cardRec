...
interface Props {
  ...
  // handleDrop: ReactEventHandler<HTMLDivElement>;
...
// const Summary3: React.FC<Props> = ({  top3Codes, uploadedFile }) => {
const Summary3: React.FC<Props> = ({
  ...
  async function summaryBenefit() {
    console.log("summaryBenefit || top3Codes ======>", top3Codes);
    try {
  ...
  useEffect(() => {
    console.log("top3BenefitResult ====>", top3BenefitResult);
  ...
  //   try {
  //     const response = await Axios.post("/api/top3Card", {
  //       top3BenefitId,
  //     });

  //     const newDividedDataObj: Record<number, any> = {};
  //     const keys = Object.keys(response.data);
  //     keys.forEach((key, idx) => {
  //       newDividedDataObj[idx + 1] = response.data[key].dividedData[0];
  //     });
  ...
  async function top3Card() {
    try {
      ...
      console.log("newDividedDataObj ====>", newDividedDataObj);
  ...
  // 2 번
  // const targetText = "Upload to your life";
  // const [currentText, setCurrentText] = useState("");
  ...
  //       setCurrentText((prevText) => prevText + targetText[charIndex]);
  //       setCharIndex((prevIndex) => prevIndex + 1);
  //     } else if (isDeleting && currentText !== "") {
  //       setCurrentText((prevText) => prevText.slice(0, -1));
  //       if (currentText === "Upload to your ") {
  //         setIsDeleting(false);
  //         setCharIndex((prevIndex) => prevIndex + 1);
  //       }
  //       console.log("^^^^^");
      ...
      {!dividedDataObj2[0] ? (
        <section style={{ maxHeight: "800px" }}>
          {/* <div>
            ...
            <button
              style={{ width: 300, border: "1px solid #000" }}
